...
<body>
<div id="contentWrap">
	<h3 class="h3_title">外呼情况统计</h3>
   	<form action="<c:url value='/agentanaly-callout.action'/>" method="post">
	<div class="queryDiv">
	   	<ul class="queryWrap_ul_w600 left">
	        ...
	        <li>
	        	<input type="button" class="btn4" onclick="location.href='${pageContext.request.contextPath }/agentanaly-exportCallout.action'" value="导出"/>
	        </li>
		</ul>
