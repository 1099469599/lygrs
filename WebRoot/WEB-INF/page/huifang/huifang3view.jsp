...
<div id="contentWrap">
	...
	<form id="form1" action="${pageContext.request.contextPath }/huifang-agentSave.action" method="post">
	...
	<div class="huifanginfo2">
	<p class="btnline">
		<input type="button" onclick="saveHuifangBtn('${flag}','0')" value="保存" class="btn4"/>
